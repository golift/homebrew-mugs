...
class Notifiarr < Formula
  ...
  homepage "{{URL}}"
  url "https://codeload.github.com/Notifiarr/notifiarr/tar.gz/v0.1.7"
  sha256 "295aababfd19962923a29e9804c18530d6e9f65d8f147a8f1dab88c71ad29654"
  head "{{URL}}"
  ...
  def install
    ...
    cd bin_path do
      system "make", "install", "VERSION=#{version}", "ITERATION=123", "PREFIX=#{prefix}", "ETC=#{etc}"
