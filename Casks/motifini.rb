...
cask "motifini" do
  ...
  on_linux do
    on_intel do
      ...
      rename "motifini_0.1.1_linux_amd64/motifini", "motifini"
    end
    on_arm do
      ...
      rename "motifini_0.1.1_linux_arm64/motifini", "motifini"
    end
  end
  ...
  service "run ["#{opt_bin}/motifini", "--config", "#{etc}/motifini.conf"]
keep_alive true
